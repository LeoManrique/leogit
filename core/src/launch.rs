...
//!     second invocation's argv to the host's single-instance handler, which
//!     focuses the window and emits [`OPEN_REPO_EVENT`] (built from
//!     [`resolve_launch_target`]) for the live frontend to handle.
//!
