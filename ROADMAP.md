...
- [x] **Force-push (with lease).** Exposed in the push button split-dropdown, behind a confirmation dialog. Backend already accepted `force_with_lease`; the UI now drives it.
